...
- 演示视频：**[▶ 点击播放 223 秒 Demo](https://pr.qiniu.zdwktlj.top/demo/pr-review-demo.mp4)** （自托管录屏，含旁白+字幕：注册登录 → 绑定 PAT → AI 审查 → R1 思维链 → AI 修复闭环（DeepSeek 生成补丁 + GPT-4.1-mini 交叉验证 + GitHub PAT 自动开 PR））
