...
- 演示视频：**[▶ 点击播放 226 秒 Demo](https://pr.qiniu.zdwktlj.top/demo/pr-review-demo.mp4)** （自托管录屏，含旁白+字幕：注册登录 → 绑定 PAT → AI 审查 → R1 思维链 → AI 修复闭环（Claude 生成补丁 + DeepSeek 审核 + GitHub PAT 自动开 PR））
